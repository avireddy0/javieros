"""
Type definitions for Slack OAuth authentication.
...
class SlackAccessToken(AccessToken):
    """AccessToken extended with Slack-specific fields."""

    session_id: Optional[str] = None
    user_id: Optional[str] = None  # Slack user ID (U...)
    team_id: Optional[str] = None  # Slack team/workspace ID (T...)
    enterprise_id: Optional[str] = None  # Slack enterprise ID (E...)
    bot_user_id: Optional[str] = None  # Bot user ID if bot token
...
class OAuth21ServiceRequest:
    ...
    session_id: Optional[str] = None
    auth_token_user: Optional[str] = None
